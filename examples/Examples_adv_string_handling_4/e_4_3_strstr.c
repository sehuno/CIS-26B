...
/* OUTPUT:
The string "is" is in "Mississippi is my sister state" 4 times.
The string "is" is in "Nonsense" 0 times.
The string "an" is in "banana anatomy" 3 times.
The string "an" is in "Andy Andrews" 0 times.
*/
